...
public class ArticleDetailFragment extends Fragment implements
    ...
    private void bindViews() {
        ...
        if (mCursor != null) {
            ...
            just(text)
                    ...
                    .subscribe((Consumer<Spanned>) bodyView::setText);
    ...
    private void getPalette(Bitmap bitmap){
        Single
                .just(bitmap)
                .map(bitmap1 -> Palette.from(bitmap1).maximumColorCount(12).generate())
                .subscribeOn(Schedulers.computation())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(this::setPaletteColor);
    }

    private void setPaletteColor(Palette palette){
    ...
    public void onLoadFinished(Loader<Cursor> cursorLoader, Cursor cursor) {
        ...
        if (mCursor != null && !mCursor.moveToFirst()) {
            ...
            Toast.makeText(getContext(), "Error reading item detail cursor. Try again", Toast.LENGTH_SHORT).show();
            mCursor.close();
            mCursor = null;
        }
